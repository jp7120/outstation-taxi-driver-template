...
//        Toast.makeText(mActivity.get(), "You have choosen $data", Toast.LENGTH_SHORT).show()
        ...
        if (data == "paytm") {
            ...
            Toast.makeText(mActivity.get(), "You have choosen PAYTM $selectedAppName", Toast.LENGTH_SHORT).show()

        }
        else
        {
            selectedAppName = "com.phonepe.app"
            Toast.makeText(mActivity.get(), "You have choosen PHONEPE $selectedAppName", Toast.LENGTH_SHORT).show()
...
//        }
    ...
    class UpiPaymentFragment : Fragment(), AnkoLogger {
        ...
        private fun startUpiBottomSheet(uri: Uri) {
            ...
            {
                info { "not avail $e" }
                mListener?.onError("App is not Available")
